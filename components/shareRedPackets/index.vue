<template>
	<view class='sharing-packets' :class='sharePacket.isState==true?"on":""'>
	   ...
	   <view class='sharing-con' @click='goShare'>
	      <image :src='isrc+"red-packets.png"'></image>
	      <view class='text'>
	        <view>会员分享返</view>
...
<style scoped lang="scss">
	...
	.sharing-packets .sharing-con .text{position:absolute;top:30rpx;font-size:20rpx;width:100%;text-align:center;color: #9142a4;}
