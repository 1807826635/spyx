			...
			<view v-if="isGoodsReturn==false">
				<view class='nav'>
					...
					<view class='progress acea-row row-between-wrapper'>
						<view class='iconfont' :class='(status.type == 0 || status.type == -9  ? "icon-webicon318":"icon-yuandianxiao") + " " + (status.type >= 0 ? "font-color-violet":"")'></view>
						<view class='line' :class='status.type > 0 ? "bg-color":""'></view>
						<view class='iconfont' :class='(status.type == 1 ? "icon-webicon318":"icon-yuandianxiao") + " " + (status.type >= 1 ? "font-color-violet":"")'></view>
						<view class='line' :class='status.type > 1 ? "bg-color":""' v-if="orderInfo.shipping_type == 1"></view>
						<view class='iconfont' :class='(status.type == 2 ? "icon-webicon318":"icon-yuandianxiao") + " " +(status.type >= 2 ? "font-color-violet":"")'
						 v-if="orderInfo.shipping_type == 1"></view>
						<view class='line' :class='status.type > 2 ? "bg-color":""'></view>
						<view class='iconfont' :class='(status.type == 3 ? "icon-webicon318":"icon-yuandianxiao") + " " + (status.type >= 3 ? "font-color-violet":"")'></view>
						<view class='line' :class='status.type > 3 ? "bg-color":""'></view>
						<view class='iconfont' :class='(status.type == 4 ? "icon-webicon318":"icon-yuandianxiao") + " " + (status.type >= 4 ? "font-color-violet":"")'></view>
					</view>
				</view>
				<!-- 拒绝退款 -->
				<view class="refund" v-if="orderInfo.refund_reason">
					<view class="title">
						<image src="http://www.runcode.pro/goods/images/shuoming.png" mode=""></image>
						商家拒绝退款
					</view>
				...
				<view class="writeOff" v-if="orderInfo.shipping_type == 2 && orderInfo.paid">
					...
					<view class="grayBg">
						<view class="written" v-if="orderInfo.status == 2">
							<image src="http://www.runcode.pro/goods/images/written.png"></image>
						</view>
						<view class="pictrue">
					...
					<view class="gear">
						<image src="http://www.runcode.pro/goods/images/writeOff.jpg"></image>
					</view>
				...
				<view class='line' v-if="orderInfo.shipping_type === 1">
					<image src='http://www.runcode.pro/goods/images/line.jpg'></image>
				</view>
			</view>
