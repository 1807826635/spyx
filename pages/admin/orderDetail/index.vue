	...
	<view class="order-details pos-order-details">
      ...
      ">
		...
		<view class="footer acea-row row-right row-middle" v-if="goname != 'looks'">
			...
			<navigator class="bnt delivery" v-if="types == 1 && orderInfo.shipping_type != 2" :url="'/pages/admin/delivery/index?id='+orderInfo.order_id">去发货</navigator>
			<navigator class="bnt delivery" v-if="types == 1 && orderInfo.shipping_type == 2" :url="'/pages/admin/order_cancellation/index'">去核销</navigator>
		</view>
