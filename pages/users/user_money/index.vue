			...
			<view class='wrapper'>
				<view class='header'>
					<view class='headerCon'>
						<view class='account acea-row row-top row-between'>
							...
							<!-- #ifdef APP-PLUS || H5 -->
							<navigator url="/pages/users/user_payment/index" hover-class="none" class='recharge font-color-violet'>充值</navigator>
							<!-- #endif -->
							<!-- #ifdef MP -->
							<view v-if="recharge_switch" @click="openSubscribe('/pages/users/user_payment/index')" class='recharge font-color-violet'>充值</view>
							<!-- #endif -->
						</view>
				...
				<view class='advert acea-row row-between-wrapper'>
					...
					<navigator class='item on acea-row row-between-wrapper' hover-class='none' url='/pages/users/user_get_coupon/index'>
						...
						<view class='pictrue'>
							<image :src='isrc+"money.png"'></image>
						</view>
					</navigator>
				</view>
				<view class='list'>
