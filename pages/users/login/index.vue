<template>
	<div class="login-wrapper">
		<div class="shading">
			<image :src="logoUrl" v-if="isLogo == 1" />
			<image :src="isrc+'logo2.png'" v-if="isLogo == 2" />
		</div>
		<div class="whiteBg" v-if="formItem === 1">
				...
				<form @submit.prevent="submit">
					<div class="item">
						<div class="acea-row row-middle">
							<image :src="isrc+'phone_1.png'" style="width: 24rpx; height: 34rpx;"></image>
							<input type="text" placeholder="输入手机号码" v-model="account" required />
						</div>
					</div>
					<div class="item">
						<div class="acea-row row-middle">
							<image :src="isrc+'code_2.png'" style="width: 28rpx; height: 32rpx;"></image>
			...
			<div class="list" v-if="current !== 0">
				...
				<div class="item" v-if="isShowCode">
					<div class="acea-row row-middle">
						<image :src="isrc+'code_2.png'"></image>
		...
		methods: {
			...
			async getLogoImage() {
				...
				getLogo(2).then(res => {
					...
					that.isLogo = res.data.logo_url?1:2
				});
			},
			async loginMobile() {
				let that = this;
