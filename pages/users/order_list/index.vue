		...
		<view class="my-order">
			<view class="header bg-color">
				<view class="picTxt acea-row row-between-wrapper">
					...
					<view class="pictrue"><image src="http://www.runcode.pro/goods/images/orderTime.png"></image></view>
				</view>
			</view>
				...
				<view class="item" v-for="(item, index) in orderList" :key="index">
					<view @click="goOrderDetails(item.order_id)">
						<view class="title acea-row row-between-wrapper">
							...
							<view v-if="item._status._type == 0" class="font-color-violet">待付款</view>
							<view v-else-if="item._status._type == 1 && item.shipping_type == 1" class="font-color-violet">待发货</view>
							<view v-else-if="item._status._type == 2 && item.shipping_type == 1" class="font-color-violet">待收货</view>
							<view v-else-if="item._status._type == 3 && item.shipping_type == 1" class="font-color-violet">待评价</view>
							<view v-else-if="item._status._type == 4 && item.shipping_type == 1" class="font-color-violet">已完成</view>
							<view v-else-if="item.shipping_type == 2 && item._status._type == 3" class="font-color-violet">待评价</view>
							<view v-else-if="item.shipping_type == 2 && item._status._type == 4" class="font-color-violet">已完成</view>
						</view>
						...
						<view class="totalPrice">
							...
							<text class="money font-color-violet">￥{{ item.pay_price }}</text>
						</view>
					</view>
