<template>
	<view>
		<view class='productList'>
			...
			<view class='nav acea-row row-middle'>
				...
				<view class='item' @click='set_where(2)'>
					价格
					<image v-if="price==1" :src='isrc+"up.png"'></image>
					<image v-else-if="price==2" :src='isrc+"down.png"'></image>
					<image v-else :src='isrc+"horn.png"'></image>
				</view>
				<view class='item' @click='set_where(3)'>
					销量
					<image v-if="stock==1" :src='isrc+"up.png"'></image>
					<image v-else-if="stock==2" :src='isrc+"down.png"'></image>
					<image v-else :src='isrc+"horn.png"'></image>
				</view>
				<!-- down -->
		...
		<view class='noCommodity' v-if="productList.length==0 && where.page > 1">
			<view class='pictrue'>
				<image :src='isrc+"noShopper.png"'></image>
			</view>
