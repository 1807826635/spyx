	...
	<div class="group-con">
		<div class="header acea-row row-between-wrapper">
			...
			<div class="text">
				...
				<div class="money">
					...
					<span class="team" v-text="storeCombination.people + '人拼'"></span>
				</div>
			</div>
		...
		<div class="wrapper">
			...
			<div class="list acea-row row-middle" :class="[pinkBool === 1 || pinkBool === -1 ? 'result' : '', iShidden ? 'on' : '']">
				...
				<div class="pictrue" v-for="index in count" :key="index"><img class="img-none" :src="isrc+'vacancy.png'" /></div>
			</div>
			...
			<div v-if="userBool === 1 && isOk == 0 && pinkBool === 0">
				<div class="teamBnt" v-if="$wechat.isWeixin()" @click="H5ShareBox = true">邀请好友参团</div>
				<div class="teamBnt" v-else @click="goPoster">邀请好友参团</div>
			</div>
			...
			<!-- #endif -->
			<!-- #ifdef MP -->
			<button open-type="share" class="teamBnt" v-if="userBool === 1 && isOk == 0 && pinkBool === 0">邀请好友参团</button>
			<!-- #endif -->
			<div class="teamBnt" v-else-if="userBool === 0 && pinkBool === 0 && count > 0" @click="pay">我要参团</div>
			<div class="teamBnt" v-if="pinkBool === 1 || pinkBool === -1" @click="goDetail(storeCombination.id)">再次开团</div>
		...
		<div class="group-recommend" v-if="storeCombinationHost.length>0">
		...
		></product-window>
		<!-- 发送给朋友图片 -->
		<view class="share-box" v-if="H5ShareBox"><image :src="isrc+'share-info.png'" @click="H5ShareBox = false"></image></view>
		<!-- #ifdef MP -->
